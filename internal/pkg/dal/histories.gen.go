...
func newHistory(db *gorm.DB, opts ...gen.DOOption) history {
	...
	_history.TicketID = field.NewInt64(tableName, "ticket_id")
	_history.Action = field.NewString(tableName, "action")
	_history.PerformedBy = field.NewString(tableName, "performed_by")
...
func (h *history) updateTableName(table string) *history {
	...
	h.TicketID = field.NewInt64(table, "ticket_id")
	h.Action = field.NewString(table, "action")
	h.PerformedBy = field.NewString(table, "performed_by")
...
func (h *history) WithContext(ctx context.Context) *historyDo { return h.historyDo.WithContext(ctx) }
